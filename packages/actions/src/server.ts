...
// export function createActionFactory<Context>(context: () => Awaitable<Context>) {
...
// export type Action<Schema extends ZodTypeAny, Result> = (input: TypeOf<Schema>) => Promise<Result>
